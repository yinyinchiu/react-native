...
class SearchBooks extends Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
            	<Text style={styles.instruction}>Search By book title and/or author</Text>
            	<View>
    ...
    fetchData() {
    	...
    	if (this.state.boolAuthor !== '') {
    		baseURL += encodeURIComponent('inauthor:' + this.state.boolAuthor);
    	}
    	if (this.state.boolTitle !== '') {
    		baseURL += (this.state.boolAuthor === '') ? encodeURIComponent('intitle:' + this.state.bookTitle) : encodeURIComponent('+intitle:' + this.state.bookTitle);
    	}
